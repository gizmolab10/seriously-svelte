<script lang='ts'>
	...
	import { T_Search, T_Layer, T_Hoverable, T_Preference, T_Search_Preference } from '../../ts/common/Global_Imports';
	...
	const s_search = elements.s_element_for(null, T_Hoverable.search, k.empty);
