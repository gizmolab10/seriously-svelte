<script lang='ts'>
	...
	import { w_rect_ofGraphView, w_show_details, w_thing_fontFamily } from '../../ts/managers/Stores';
	import { elements, k, p, controls, Point, search } from '../../ts/common/Global_Imports';
	...
	let graph_width = $w_rect_ofGraphView.size.width - ($w_show_details ? 0 : 5);
	...
	$: {
		graph_width = $w_rect_ofGraphView.size.width + ($w_show_details ? 0 : 5);
