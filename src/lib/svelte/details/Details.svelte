<script lang='ts'>
	import { c, k, u, ux, Point, layout, T_Layer, T_Graph, T_Detail, T_Direction } from '../../ts/common/Global_Imports';
	...
	$: {
		const _ = `${$w_search_state}:::${ux.si_found.w_index}:::${u.description_byTitles($w_grabbed)}`;
