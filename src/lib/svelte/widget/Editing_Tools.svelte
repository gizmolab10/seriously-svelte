<script lang='ts'>
	...
	import { svgPaths, signals, Direction, Graph_Type } from '../../ts/common/Global_Imports';
	...
	function titleOffsetX(): number {
		if (!!ancestry) {
			...
			return g.showing_rings ? forward ? titleWidth + 23 : -6 : shows_Reveal ? titleWidth + 25 : titleWidth + 17;
		}
		return 0;
	}
