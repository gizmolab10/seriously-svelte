<script>
	import { TypeDB, ZIndex, PersistID, ButtonID, Hierarchy, dbDispatch, persistLocal } from '../../ts/common/GlobalImports';
	...
	const menuItems = [
		{ id: TypeDB.local,	   label: 'built in', action: () => { handleDBTypeAt(0); } },
