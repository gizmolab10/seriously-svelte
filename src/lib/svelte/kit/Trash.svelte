...
<div class='trash-container'>
	<svg width={k.default_buttonSize} height={k.default_buttonSize} fill={invert ? color : fill} stroke={color} viewBox={viewBox}>
	...
	<svg width={k.default_buttonSize} height={k.default_buttonSize} fill={invert ? fill : color} stroke={invert ? fill : color} viewBox={viewBox}>
