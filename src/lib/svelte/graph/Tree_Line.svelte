<script lang='ts'>
	import { Point, G_TreeLine, T_Layer, S_Component, T_Detectable } from '../../ts/common/Global_Imports';
	...
	s_component = signals.handle_reposition_widgets_atPriority(2, ancestry, T_Detectable.line, (received_ancestry) => {
		reattachments += 1;
	});
