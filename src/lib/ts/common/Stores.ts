...
export const w_e_countDots			  = writable<Array<T_Kinship>>();
export const w_e_tree				  = writable<Array<T_Kinship>>();
export const w_e_details			  = writable<Array<T_Details>>();
...
export const w_e_startup			  = writable<T_Startup>();
export const w_g_paging				  = writable<G_Paging>();
export const w_e_graph				  = writable<T_Graph>();
...
class Stores {
	setup_defaults() {
		...
		w_e_startup.set(T_Startup.start);
