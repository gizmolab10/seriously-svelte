...
import { T_File_Format, T_File_Operation, T_Startup, T_Kinship, T_RingZone, T_Preference, T_Auto_Fit } from './Enumerations';
...
export {
	...
	T_Action, T_Control, T_Browser, T_Storage_Need, T_Auto_Fit,
