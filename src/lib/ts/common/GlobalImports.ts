import { IDTrait, ZIndex, Angle, Quadrant, IDButton, IDBrowser, Alteration, PredicateKind } from './Enumerations';
...
export {
	...
	ZIndex, DBType, DatumType, PredicateKind, CreationOptions, Alteration,
};
