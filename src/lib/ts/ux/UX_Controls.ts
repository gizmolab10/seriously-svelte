...
class UX_Controls {
	...
	get inTreeMode(): boolean { return get(show.w_graph_ofType) == T_Graph.tree; }
	get inRadialMode(): boolean { return get(show.w_graph_ofType) == T_Graph.radial; }
	...
	toggle_graph_type() {
		switch (get(show.w_graph_ofType)) {
			case T_Graph.tree:   show.w_graph_ofType.set(T_Graph.radial); break;
			case T_Graph.radial: show.w_graph_ofType.set(T_Graph.tree);   break;
		}
		layout.grand_sweep();
	}
