export default class MouseState {
	...
	static hover(event: Event | null, element: HTMLElement, isHovering: boolean) { return new MouseState(event, element, true, !isHovering, false, false, false, false); }
	static clicks(event: Event | null, element: HTMLElement, clickCount: number) { return new MouseState(event, element, false, false, false, false, clickCount > 1, false); }
}
