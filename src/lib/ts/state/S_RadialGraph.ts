import { k, hits, debug, layout, elements, g_radial } from '../common/Global_Imports';
import { S_Rotation, S_Resizing, G_Thing_Pages } from '../common/Global_Imports';
import { T_Radial_Zone, T_Detectable } from '../common/Global_Imports';
...
export default class S_RadialGraph {
	...
	get ring_zone_atMouseLocation(): T_Radial_Zone {
		...
		const widgets = hits.hits_atPoint_ofType(mouse_vector, T_Detectable.widget);
