...
export default class S_Rotation {
	...
	get fill_opacity(): number { return this.show_border ? 0.1 : 0; }
	get stroke_opacity(): number { return this.show_border ? 0.4 : 0; }
	get show_border(): boolean { return (this.isHovering || this.isActive); }
