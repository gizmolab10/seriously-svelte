...
The core architecture components form the foundation of webseriously's data model and system behavior.
## Components
- [Components](./components.md) - Svelte component architecture and patterns
- [Databases](./databases.md) - Database abstraction layer
