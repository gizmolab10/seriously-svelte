...
For timing logic (autorepeat, long-click, double-click), see [timers.md](./timers.md).
...
- [x] **Complete** — All mouse timing centralized (see [timers.md](./timers.md))
- [ ] Remaining work
...
4. Hits handles timing centrally (see [timers.md](./timers.md))
...
For timing tests (autorepeat, double-click, long-click), see [timers.md](./timers.md#testing).
