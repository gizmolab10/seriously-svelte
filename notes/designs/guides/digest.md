...
### [bubble.md](../architecture/other/bubble.md)
...
### [database.md](../architecture/core/databases.md)
...
### [state.md](../architecture/core/state.md) (stores inventory)
...
### [widget_title.md](../work/done/widget_title.md)
